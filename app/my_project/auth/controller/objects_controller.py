...
def create_objects_controller(mysql):
    ...
    def get_objects():
        ...
        200:
            ...
            examples:
            application/json: [
                {"object_id": 1, "name": "Office", "location": "Kyiv"},
                {"object_id": 2, "name": "Office", "location": "Lviv"}
            ]
        """
    ...
    def create_objects():
        ...
        201:
            ...
            examples:
            application/json: {"message": "Objects created"}
        400:
            description: Invalid input data
            examples:
            application/json: {"error": "Invalid data"}
        500:
            description: Internal server error
            examples:
            application/json: {"error": "Database connection failed"}
        """
        data = request.json
